...
build_ffmpeg() {
  ...
  cd $output_dir
    ...
    config_options="$init_options --disable-filters  --disable-protocols --disable-hwaccels --disable-encoders --enable-encoder=pcm_s8  --enable-encoder=pcm_u8  --enable-encoder=pcm_s16be --enable-encoder=pcm_s16le  --enable-encoder=pcm_u16be  --enable-encoder=pcm_u16le  --enable-encoder=libmp3lame  --enable-libmp3lame  --enable-version3  --enable-nonfree  --disable-bsfs  --disable-parsers  --enable-parser=mpegaudio  --disable-demuxers  --enable-demuxer=wav  --enable-demuxer=mp3    --disable-muxers --enable-muxer=mp3  --enable-muxer=wav  --disable-decoders  --enable-decoder=mp3  --enable-decoder=wavpack  --enable-decoder=pcm_s8 --enable-decoder=pcm_u8 --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le"
    # --------delete this
    if [[ $compiler_flavors != "native" ]]; then
